...
//	public Page<CamelHashMap> getItemFileList(@Param("fileNo") int fileNo, Page pageable);
	...
	Page<Item> findByItemNameContainingOrItemPriceContainingOrItemRegdateContainingOrItemStatusContaining(String searchKeyword1, String searchKeyword2, String searchKeyword3, String searchKeyword4, Pageable pageable);
